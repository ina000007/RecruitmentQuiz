...
public class Question {
	...
	public Question(Long id, String questionDesc, String option1, String option2, String option3, String option4,
			String selectedOpt) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Question [id=" + id + ", questionDesc=" + questionDesc + ", option1=" + option1 + ", option2=" + option2
				+ ", option3=" + option3 + ", option4=" + option4 + ", selectedOpt=" + selectedOpt + "]";
	}
